...
Call apply_styles() at the top of every page to ensure
consistent sidebar color, header, and card styles.
"""
...
def apply_styles():
    """Apply global CSS to every report page — sidebar teal, header hidden, cards."""
    st.markdown(f"""
    <style>
      /* ── Page background ── */
